...
export const networks = {
  unknown: {
    ...
    contractId: "CAXL66X3I7SWI4SFZIBDYUZOK5A23XOE3ZF6LEBGXGXQFPYSQKY4YZID",
  }
} as const
...
sender: string;
  /**
 * Optional client-computed swap amount hint for gas optimization.
 * 
 * When zapping, the input must be split between token0 and token1. This hint
 * tells the contract how much to swap (avoiding on-chain calculation).
 * - `None`: Contract calculates optimal split on-chain (costs more gas)
 * - `Some(amount)`: Contract uses this value (get it from `quote_zap_in`)
 * 
 * The hint is validated against slippage bounds regardless.
 */
...
export interface Client {
   ...
   */
  init: ({factory, xlm, position_manager}: {factory: string, xlm: string, position_manager: string}, options?: {
    /**
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "",
        "AAAABQAAAB9aYXAgcm91dGVyIGluaXRpYWxpemF0aW9uIGV2ZW50AAAAAAAAAAATWmFwSW5pdGlhbGl6ZWRFdmVudAAAAAABAAAAD3phcF9pbml0aWFsaXplZAAAAAACAAAAAAAAAAdmYWN0b3J5AAAAABMAAAAAAAAAAAAAABBwb3NpdGlvbl9tYW5hZ2VyAAAAEwAAAAAAAAAC",
        "",
        "",
