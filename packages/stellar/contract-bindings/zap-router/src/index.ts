...
export const networks = {
  futurenet: {
    ...
    contractId: "CCPBZWY56PHGMUHNFH22SUFBXPBSK7RBBFPPG5XOSONJWC44ZCO3R3BB",
  }
} as const
 ...
 */
export type ZapRouterDataKey = {tag: "Factory", values: void} | {tag: "XlmAddress", values: void} | {tag: "PositionManager", values: void} | {tag: "SwapRouter", values: void};
...
/**
 * ExactInputParams for swap_router (must match swap_router's type exactly!)
 * CRITICAL: Field order matters for Soroban serialization - must match swap-router/src/types.rs
 */
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "",
        ...
        "",
